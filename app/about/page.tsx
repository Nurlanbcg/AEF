      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Azərbaycan Elm Fondu</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Button variant="outline" className="justify-between h-auto p-4 bg-transparent">
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-500">PDF, 2.1 MB</div>
                </div>
              ...
              <Button variant="outline" className="justify-between h-auto p-4 bg-transparent">
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-500">PDF, 4.5 MB</div>
                </div>
                <ExternalLink className="h-4 w-4" />
              </Button>
            </div>
